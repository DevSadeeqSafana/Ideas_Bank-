...
async function GET(request, { params }) {
    ...
    try {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(traineeData);
    } catch (error) {
...
async function PUT(request, { params }) {
    try {
        ...
        WHERE id = ?`, [
                ...
                data.account_name,
                data.bvn,
                data.HaveStarted ? 1 : 0,
                data.AcceptanceLetter,
                data.hascompleted ? 1 : 0,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__723fc443._.js.map