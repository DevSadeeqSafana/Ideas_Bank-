...
"[project]/src/app/verify-info/page.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function VerifyInfoContent() {
    ...
    const traineeId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$traineeUtils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getTraineeIdFromParams"])(searchParams);
    const { userInfo, updateUserInfo, getTraineeId } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useUserInfo$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useUserInfo"])();
    const [formData, setFormData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])({
        date_of_birth: '',
        nin: ''
    });
    const [traineeData, setTraineeData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        // Only fetch from API once when component mounts
        // Use traineeId from params or fallback to stored data
        const effectiveTraineeId = traineeId || getTraineeId();
        if (effectiveTraineeId && router) {
            fetch(`/api/trainee/${effectiveTraineeId}`).then((res)=>res.json()).then((data)=>{
                setTraineeData(data);
                setFormData({
    ...
    const handleSubmit = async (e)=>{
        ...
        if (!effectiveTraineeId) {
            console.error("No trainee ID available for submission");
            return;
        }
        try {
            const response = await fetch(`/api/trainee/${effectiveTraineeId}`, {
                method: 'PUT',
                headers: {
            ...
            if (response.ok) {
                ...
                router.push(`/internship-info?traineeId=${effectiveTraineeId}`);
            } else {
...
function VerifyInfoPage() {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Suspense"], {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(VerifyInfoContent, {}, void 0, false, {
            fileName: "[project]/src/app/verify-info/page.js",
            lineNumber: 150,
            columnNumber: 7
        }, this)
...
//# sourceMappingURL=%5Broot-of-the-server%5D__df72d729._.js.map