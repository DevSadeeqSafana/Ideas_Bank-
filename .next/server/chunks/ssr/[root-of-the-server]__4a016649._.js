...
"[project]/src/app/personal-info/[id]/page.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function PersonalInfoPage() {
    ...
    const { formData } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useUserInfo$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useFormData"])('personal');
    const handleSubmit = async (e)=>{
        e.preventDefault();
        try {
            // Get trainee ID from current formData using standardized method
            const traineeId = formData.traineeId;
            if (traineeId) {
                console.log("Navigating with traineeId:", traineeId);
                router.push(`/bank-info?traineeId=${traineeId}`);
            } else {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4a016649._.js.map