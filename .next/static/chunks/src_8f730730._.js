...
function VerifyInfoContent() {
    ...
    const traineeId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$traineeUtils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getTraineeIdFromParams"])(searchParams);
    const { userInfo, updateUserInfo, getTraineeId } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useUserInfo$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUserInfo"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "VerifyInfoContent.useEffect": ()=>{
            ...
            if (effectiveTraineeId && router) {
                fetch("/api/trainee/".concat(effectiveTraineeId)).then({
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            const response = await fetch("/api/trainee/".concat(effectiveTraineeId), {
                method: 'PUT',
                headers: {
            ...
            if (response.ok) {
                ...
                router.push("/internship-info?traineeId=".concat(effectiveTraineeId));
            } else {
...
_s(VerifyInfoContent, "J18cV8ZlY3FcyWUNbTmBT6nZUFo=", false, function() {
    return [
...
//# sourceMappingURL=src_8f730730._.js.map