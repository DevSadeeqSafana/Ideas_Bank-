...
"[project]/node_modules/@tanstack/query-persist-client-core/build/modern/index.js [app-client] (ecmascript) <locals>": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@tanstack/query-persist-client-core/build/modern/index.js [app-client] (ecmascript) <module evaluation>": ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s({});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$query$2d$persist$2d$client$2d$core$2f$build$2f$modern$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@tanstack/query-persist-client-core/build/modern/index.js [app-client] (ecmascript) <locals>");
}),
"[project]/node_modules/@tanstack/query-persist-client-core/build/modern/retryStrategies.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var removeOldestQuery = (param)=>{
    let { persistedClient } = param;
    const mutations = [
...
"[project]/node_modules/@tanstack/query-persist-client-core/build/modern/createPersister.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function experimental_createQueryPersister(param) {
    let { storage, buster = "", maxAge = 1e3 * 60 * 60 * 24, serialize = JSON.stringify, deserialize = JSON.parse, prefix = PERSISTER_KEY_PREFIX, filters } = param;
    ...
    async function retrieveQuery(queryHash, afterRestoreMacroTask) {
        if (storage != null) {
            const storageKey = "".concat(prefix, "-").concat(queryHash);
            try {
    ...
    async function persistQueryByKey(queryKey, queryClient) {
        if (storage != null) {
            ...
            if (query) {
                ...
                if ("TURBOPACK compile-time truthy", 1) {
                    console.warn("Could not find query to be persisted. QueryKey:", JSON.stringify(queryKey));
                }
            }
        }
    }
    async function persistQuery(query) {
        if (storage != null) {
            const storageKey = "".concat(prefix, "-").concat(query.queryHash);
    ...
    async function persisterFn(queryFn, ctx, query) {
        const matchesFilter = filters ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$query$2d$core$2f$build$2f$modern$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["matchQuery"])(filters, query) : true;
    ...
    async function persisterGc() {
        if (storage === null || storage === void 0 ? void 0 : storage.entries) {
            ...
            throw new Error("Provided storage does not implement `entries` method. Garbage collection is not possible without ability to iterate over storage items.");
        }
    }
    async function restoreQueries(queryClient) {
        ...
        if (storage === null || storage === void 0 ? void 0 : storage.entries) {
            ...
            for (const [key, value] of entries){
                if (key.startsWith(prefix)) {
                    ...
                    if (queryKey) {
                        if (exact) {
                            if (persistedQuery.queryHash !== (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$query$2d$core$2f$build$2f$modern$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["hashKey"])(queryKey)) {
                                continue;
                            }
                        } else if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$query$2d$core$2f$build$2f$modern$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["partialMatchKey"])(persistedQuery.queryKey, queryKey)) {
                            continue;
                        }
                    }
            ...
            throw new Error("Provided storage does not implement `entries` method. Restoration of all stored entries is not possible without ability to iterate over storage items.");
        }
    }
    return {
        persisterFn,
...
"[project]/node_modules/@tanstack/query-persist-client-core/build/modern/index.js [app-client] (ecmascript) <exports>": ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s({
    "PERSISTER_KEY_PREFIX": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$query$2d$persist$2d$client$2d$core$2f$build$2f$modern$2f$createPersister$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PERSISTER_KEY_PREFIX"],
    "experimental_createQueryPersister": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$query$2d$persist$2d$client$2d$core$2f$build$2f$modern$2f$createPersister$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["experimental_createQueryPersister"],
    "persistQueryClient": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$query$2d$persist$2d$client$2d$core$2f$build$2f$modern$2f$persist$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["persistQueryClient"],
    "persistQueryClientRestore": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$query$2d$persist$2d$client$2d$core$2f$build$2f$modern$2f$persist$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["persistQueryClientRestore"],
    "persistQueryClientSave": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$query$2d$persist$2d$client$2d$core$2f$build$2f$modern$2f$persist$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["persistQueryClientSave"],
    "persistQueryClientSubscribe": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$query$2d$persist$2d$client$2d$core$2f$build$2f$modern$2f$persist$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["persistQueryClientSubscribe"],
    "removeOldestQuery": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$query$2d$persist$2d$client$2d$core$2f$build$2f$modern$2f$retryStrategies$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["removeOldestQuery"]
});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$query$2d$persist$2d$client$2d$core$2f$build$2f$modern$2f$persist$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@tanstack/query-persist-client-core/build/modern/persist.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$query$2d$persist$2d$client$2d$core$2f$build$2f$modern$2f$retryStrategies$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@tanstack/query-persist-client-core/build/modern/retryStrategies.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$query$2d$persist$2d$client$2d$core$2f$build$2f$modern$2f$createPersister$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@tanstack/query-persist-client-core/build/modern/createPersister.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$query$2d$persist$2d$client$2d$core$2f$build$2f$modern$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@tanstack/query-persist-client-core/build/modern/index.js [app-client] (ecmascript) <locals>");
}),
"[project]/node_modules/@tanstack/query-persist-client-core/build/modern/index.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s({
    "PERSISTER_KEY_PREFIX": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$query$2d$persist$2d$client$2d$core$2f$build$2f$modern$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$exports$3e$__["PERSISTER_KEY_PREFIX"],
    "experimental_createQueryPersister": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$query$2d$persist$2d$client$2d$core$2f$build$2f$modern$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$exports$3e$__["experimental_createQueryPersister"],
    "persistQueryClient": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$query$2d$persist$2d$client$2d$core$2f$build$2f$modern$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$exports$3e$__["persistQueryClient"],
    "persistQueryClientRestore": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$query$2d$persist$2d$client$2d$core$2f$build$2f$modern$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$exports$3e$__["persistQueryClientRestore"],
    "persistQueryClientSave": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$query$2d$persist$2d$client$2d$core$2f$build$2f$modern$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$exports$3e$__["persistQueryClientSave"],
    "persistQueryClientSubscribe": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$query$2d$persist$2d$client$2d$core$2f$build$2f$modern$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$exports$3e$__["persistQueryClientSubscribe"],
    "removeOldestQuery": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$query$2d$persist$2d$client$2d$core$2f$build$2f$modern$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$exports$3e$__["removeOldestQuery"]
});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$query$2d$persist$2d$client$2d$core$2f$build$2f$modern$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i("[project]/node_modules/@tanstack/query-persist-client-core/build/modern/index.js [app-client] (ecmascript) <module evaluation>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$query$2d$persist$2d$client$2d$core$2f$build$2f$modern$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$exports$3e$__ = __turbopack_context__.i("[project]/node_modules/@tanstack/query-persist-client-core/build/modern/index.js [app-client] (ecmascript) <exports>");
}),
"[project]/node_modules/@tanstack/react-query-persist-client/build/modern/index.js [app-client] (ecmascript) <locals>": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@tanstack/react-query-persist-client/build/modern/index.js [app-client] (ecmascript) <exports>": ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s({
    "PERSISTER_KEY_PREFIX": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$query$2d$persist$2d$client$2d$core$2f$build$2f$modern$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PERSISTER_KEY_PREFIX"],
    "PersistQueryClientProvider": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2d$persist$2d$client$2f$build$2f$modern$2f$PersistQueryClientProvider$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PersistQueryClientProvider"],
    "experimental_createQueryPersister": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$query$2d$persist$2d$client$2d$core$2f$build$2f$modern$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["experimental_createQueryPersister"],
    "persistQueryClient": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$query$2d$persist$2d$client$2d$core$2f$build$2f$modern$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["persistQueryClient"],
    "persistQueryClientRestore": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$query$2d$persist$2d$client$2d$core$2f$build$2f$modern$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["persistQueryClientRestore"],
    "persistQueryClientSave": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$query$2d$persist$2d$client$2d$core$2f$build$2f$modern$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["persistQueryClientSave"],
    "persistQueryClientSubscribe": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$query$2d$persist$2d$client$2d$core$2f$build$2f$modern$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["persistQueryClientSubscribe"],
    "removeOldestQuery": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$query$2d$persist$2d$client$2d$core$2f$build$2f$modern$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["removeOldestQuery"]
});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$query$2d$persist$2d$client$2d$core$2f$build$2f$modern$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@tanstack/query-persist-client-core/build/modern/index.js [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2d$persist$2d$client$2f$build$2f$modern$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@tanstack/react-query-persist-client/build/modern/index.js [app-client] (ecmascript) <locals>");
}),
}]);

//# sourceMappingURL=node_modules_7899ab63._.js.map