...
function InternshipInfoPage() {
    ...
    const states = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "InternshipInfoPage.useMemo[states]": ()=>{
            return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$nigeria$2d$state$2d$and$2d$lgas$2e$json__$28$json$29$__["default"].map({
                "InternshipInfoPage.useMemo[states]": (item)=>item.state
            }["InternshipInfoPage.useMemo[states]"]).sort();
        }
    }["InternshipInfoPage.useMemo[states]"], []);
    const availableLGAs = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "InternshipInfoPage.useMemo[availableLGAs]": ()=>{
            ...
            const selectedState = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$nigeria$2d$state$2d$and$2d$lgas$2e$json__$28$json$29$__["default"].find({
                "InternshipInfoPage.useMemo[availableLGAs].selectedState": (item)=>item.state === formData.state_of_internship
            }["InternshipInfoPage.useMemo[availableLGAs].selectedState"]);
...
_s(InternshipInfoPage, "9LeDrvs54cvEr8Tz2LFF4DegOak=", false, function() {
    return [
...
//# sourceMappingURL=src_f1ad6fb0._.js.map